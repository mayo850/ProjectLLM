...
1. Ensure you have a fresh install by **backing up** and then deleting the following directories:
    ...
    ### Windows
      * Settings directory: ```C:\Users\{username}\AppData\Roaming\vm.ai```
      * Models directory: ```C:\Users\{username}\AppData\Local\vm.ai\ProjectLLM```
    ### Mac
      * Settings directory: ```/Users/{username}/.config/llm.io```
      * Models directory: ```/Users/{username}/Library/Application Support/vm.ai/llm```
    ### Linux
      * Settings directory: ```/home/{username}/.config/vm.ai```
      * Models directory: ```/home/{username}/.local/share/vm.ai/llm```
