...
Window {
    ...
    visible: true
    title: qsTr("VM Phase 1 v1")

    SystemTrayIcon {
        id: systemTrayIcon
        property bool shouldClose: false
        visible: MySettings.systemTray && !shouldClose
        icon.source: "qrc:/ProjectLLM/icons/ProjectLLM_transparent.svg"
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            MyToolButton {
                ...
                source: "qrc:/ProjectLLM/icons/home.svg"
            ...
            MyToolButton {
                ...
                imageWidth: 25 * theme.fontScale
                imageHeight: 25 * theme.fontScale
                source: "qrc:/ProjectLLM/icons/chat.svg"
            ...
            MyToolButton {
                ...
                imageWidth: 25 * theme.fontScale
                imageHeight: 25 * theme.fontScale
                source: "qrc:/ProjectLLM/icons/models.svg"
            ...
            MyToolButton {
                ...
                imageWidth: 25 * theme.fontScale
                imageHeight: 25 * theme.fontScale
                source: "qrc:/ProjectLLM/icons/settings.svg"
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Image {
                    ...
                    source: "qrc:/ProjectLLM/icons/antenna_3.svg"
                }
                ...
                SequentialAnimation {
                    ...
                    PropertyAnimation {
                        ...
                        property: "source"
                        duration: 500
                        from: "qrc:/ProjectLLM/icons/antenna_1.svg"
                        to: "qrc:/ProjectLLM/icons/antenna_2.svg"
                    }
                    ...
                    PropertyAnimation {
                        ...
                        property: "source"
                        duration: 500
                        from: "qrc:/ProjectLLM/icons/antenna_2.svg"
                        to: "qrc:/ProjectLLM/icons/antenna_3.svg"
                    }
                    ...
                    PropertyAnimation {
                        ...
                        property: "source"
                        duration: 500
                        from: "qrc:/ProjectLLM/icons/antenna_3.svg"
                        to: "qrc:/ProjectLLM/icons/antenna_2.svg"
                    }
                    ...
                    PropertyAnimation {
                        ...
                        duration: 1500
                        from: "qrc:/ProjectLLM/icons/antenna_2.svg"
                        to: "qrc:/ProjectLLM/icons/antenna_1.svg"
                    }
            ...
            Rectangle {
                ...
                ColorOverlay {
                    ...
                    TapHandler {
                        onTapped: function(eventPoint, button) {
                            Qt.openUrlExternally("https://vonmaur.com")
                        }
                    }
                }
            }
