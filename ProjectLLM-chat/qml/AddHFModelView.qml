...
ColumnLayout {
    ...
    Label {
        ...
        text: qsTr("Use the search to find and download models from HuggingFace. There is NO GUARANTEE that these " +
                   "will work. Many will require additional configuration before they can be used. (I will try to create Documentation on this but after i get this working first :)")
