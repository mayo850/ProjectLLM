...
GridLayout {
    ...
    Item {
        ...
        Image {
            ...
            mipmap: true
            visible: false
            source: name !== "Response: " ? "qrc:/ProjectLLM/icons/you.svg" : "qrc:/ProjectLLM/icons/regenerate.svg"
        }
                    ...
                    Image {
                        ...
                        source: {
                            if (sourcesLayout.state === "collapsed")
                                return "qrc:/ProjectLLM/icons/caret_right.svg";
                            else
                                return "qrc:/ProjectLLM/icons/caret_down.svg";
                        }
                    }
    ...
    RowLayout {
        ...
        ChatMessageButton {
            ...
            source: "qrc:/ProjectLLM/icons/edit.svg"
            onClicked: {
                if (inputBoxText === "")
        ...
        Item {
            ...
            ChatMessageButton {
                ...
                source: "qrc:/ProjectLLM/icons/thumbs_up.svg"
            ...
            ChatMessageButton {
                ...
                source: "qrc:/ProjectLLM/icons/thumbs_down.svg"
...
GridLayout {
    ...
    Item {
        ...
        Image {
            ...
            mipmap: true
            visible: false
            source: "qrc:/ProjectLLM/icons/stack.svg"
        }
            ...
            TextArea {
                ...
                Item {
                    ...
                    Image {
                        ...
                        mipmap: true
                        visible: false
                        source: "qrc:/ProjectLLM/icons/plus.svg"
                    }
