    ...
    Column {
        ...
        Item {
            ...
            Image {
                ...
                width: 60
                height: 60
                source: "qrc:/ProjectLLM/icons/ProjectLLM.svg"
            }
            Text {
                anchors.left: img.right
                anchors.leftMargin: 30
                anchors.verticalCenter: img.verticalCenter
                text: qsTr("Share Feedback and sample data.")
        ...
        ScrollView {
            ...
            MyTextArea {
                ...
                text: qsTr("By enabling this feature, you will be able to participate in the democratic process of "
                      ...
                      + "future versions of models. We will retain all attribution information attached to your data.")
                focus: false
                readOnly: true
