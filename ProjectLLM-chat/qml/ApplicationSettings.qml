...
MySettingsTab {
    ...
    Dialog {
        ...
        Text {
            ...
            text: qsTr("ERROR: Update system could not find the MaintenanceTool used to check for updates!<br/><br/>"
                  + "Did you install this application using software center?")
    ...
    contentItem: GridLayout {
        ...
        MySettingsLabel {
            id: dataLakeLabel
            text: qsTr("Enable IS Feedback")
            helpText: qsTr("Send chats and feedback to the Von Maur table for improvements.")
            Layout.row: 9
            Layout.column: 0
        }
        MyCheckBox {
        ...
        MySettingsLabel {
            ...
            helpText: qsTr("Manually check for an update.");
            Layout.row: 16
            Layout.column: 0
        }
