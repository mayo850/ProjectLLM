...
QtObject {
    ...
    // blue 
property color vmblue50: Qt.hsla(216/360, 0.18, 0.97)
property color vmblue100: Qt.hsla(216/360, 0.21, 0.93)
property color vmblue200: Qt.hsla(216/360, 0.21, 0.85)
property color vmblue300: Qt.hsla(216/360, 0.20, 0.73)
property color vmblue400: Qt.hsla(216/360, 0.19, 0.58)
property color vmblue500: Qt.hsla(216/360, 0.19, 0.45)
property color vmblue600: Qt.hsla(216/360, 1.0, 0.16)  // #002050 equivalent
property color vmblue700: Qt.hsla(216/360, 0.19, 0.29)
property color vmblue800: Qt.hsla(216/360, 0.17, 0.24)
property color vmblue900: Qt.hsla(216/360, 0.17, 0.20)
property color vmblue950: Qt.hsla(216/360, 0.22, 0.10)
property color vmblue300_sat: Qt.hsla(216/360, 0.24, 0.73)
property color vmblue400_sat: Qt.hsla(216/360, 0.23, 0.58)
property color vmblue450_sat: Qt.hsla(216/360, 0.23, 0.52)
...
*/
    ...
    switch (MySettings.chatTheme) {
        case MySettingsEnums.ChatTheme.LegacyDark:
            return purple400  // Good contrast against dark background
        case MySettingsEnums.ChatTheme.Dark:
            return vmblue400  // Lighter blue for better visibility
        default:
            return vmblue600  // Good for light themes
    }
}
...
property color progressBackground: {
    switch (MySettings.chatTheme) {
        case MySettingsEnums.ChatTheme.LegacyDark:
            return blue800  // Slightly lighter than blue900 for better contrast
        case MySettingsEnums.ChatTheme.Dark:
            return darkgray400  // Much lighter than vmblue600 for contrast
        default:
            return vmblue100  // Light blue background for light theme
    }
}
...
property color altProgressForeground: {
    switch (MySettings.chatTheme) {
        case MySettingsEnums.ChatTheme.LegacyDark:
            return yellow400  // Better contrast than purple
        default:
            return "#f0b345"  // Warmer yellow for better visibility
    }
}
...
property color altProgressBackground: {
    switch (MySettings.chatTheme) {
        case MySettingsEnums.ChatTheme.LegacyDark:
            return blue800  // Better contrast
        default:
            return "#f9e3b8"  // Softer yellow background
    }
}
...
property color altProgressText: {
    switch (MySettings.chatTheme) {
        case MySettingsEnums.ChatTheme.LegacyDark:
            return yellow200  // Brighter text for dark theme
        default:
            return "#b35900"  // Darker orange for better readability
    }
}
    ...
    property color mediumButtonBackgroundHovered: {
        switch (MySettings.chatTheme) {
            case MySettingsEnums.ChatTheme.LegacyDark:
                return purple450
            case MySettingsEnums.ChatTheme.Dark:
                return vmblue450_sat
            default:
                return vmblue300_sat
        }
    }
