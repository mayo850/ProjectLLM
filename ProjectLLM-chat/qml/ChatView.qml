...
Rectangle {
    ...
    PopupDialog {
        ...
        text: qsTr("<h3>Encountered an error loading model:</h3><br>"
              ...
              + "<li>If you've sideloaded the model ensure the file is not corrupt").arg(currentChat.modelLoadingError);
    }
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    MyToolButton {
                        ...
                        imageHeight: 40
                        padding: 15
                        source: mainArea.state === "expanded" ? "qrc:/ProjectLLM/icons/left_panel_open.svg" : "qrc:/ProjectLLM/icons/left_panel_closed.svg"
                        ...
                        RowLayout {
                            ...
                            RowLayout {
                                ...
                                MyMiniButton {
                                    ...
                                    source: "qrc:/ProjectLLM/icons/regenerate.svg"
                                ...
                                MyMiniButton {
                                    ...
                                    source: "qrc:/ProjectLLM/icons/eject.svg"
                                    backgroundColor: theme.textColor
                                    backgroundColorHovered: theme.styledTextColor
                                    onClicked: {
                            ...
                            Item {
                                ...
                                Image {
                                    ...
                                    mipmap: true
                                    visible: false
                                    source: "qrc:/ProjectLLM/icons/up_down.svg"
                                }
                ...
                Rectangle {
                    ...
                    MyButton {
                        ...
                        contentItem: RowLayout {
                            ...
                            Item {
                                ...
                                Image {
                                    ...
                                    mipmap: true
                                    visible: false
                                    source: "qrc:/ProjectLLM/icons/db.svg"
                                }
                        ...
                        background: Rectangle {
                            ...
                            // TODO: either use collectionsButton-specific theming, or don't - this is inconsistent
        ...
        Rectangle {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                ...
                                Image {
                                    ...
                                    mipmap: true
                                    visible: false
                                    source: "qrc:/ProjectLLM/icons/nomic_logo.svg"
                                }
                        ...
                        MyButton {
                            ...
                            // function only works after the combobox component is loaded so i have
                            // to use my own component loaded to make this work along with a signal
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                ...
                                text: qsTr("IS requires that you install at least one\nmodel to get started")
                                font.pixelSize: theme.fontSizeLarge
                            }
                        }
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    MyToolButton {
                        ...
                        source: "qrc:/ProjectLLM/icons/recycle.svg"
                        imageWidth: 20
                        imageHeight: 20
                    ...
                    MyToolButton {
                        ...
                        Layout.preferredWidth: 40
                        Layout.preferredHeight: 40
                        source: "qrc:/ProjectLLM/icons/copy.svg"
                        imageWidth: 20
                        imageHeight: 20
                        TextEdit{
                            id: copyEdit
            ...
            Rectangle {
                ...
                GridLayout {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                ...
                                MyMiniButton {
                                    ...
                                    source: "qrc:/ProjectLLM/icons/close.svg"
                                    onClicked: {
                    ...
                    MyToolButton {
                        ...
                        source: "qrc:/ProjectLLM/icons/paperclip.svg"
                    ...
                    Row {
                        ...
                        MyToolButton {
                            ...
                            background: Item {
                                ...
                                Image {
                                    ...
                                    source: "qrc:/ProjectLLM/icons/stop_generating.svg"
                                }
                                Rectangle {
                        ...
                        MyToolButton {
                            ...
                            source: "qrc:/ProjectLLM/icons/send_message.svg"
            ...
            MyMenu {
                ...
                MyMenuItem {
                    ...
                    icon.source: "qrc:/ProjectLLM/icons/file.svg"
                    icon.width: 24
                    icon.height: 24
                    onClicked: {
