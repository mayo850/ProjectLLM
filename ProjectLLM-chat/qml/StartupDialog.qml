    ...
    Column {
        ...
        Item {
            ...
            Image {
                ...
                mipmap: true
                visible: false
                source: "qrc:/ProjectLLM/icons/globe.svg"
            }
            ColorOverlay {
                anchors.fill: img
                source: img
        ...
        ScrollView {
            ...
            MyTextArea {
                ...
                textFormat: TextEdit.MarkdownText
                text: qsTr(
                "### Opt-ins for anonymous usage analytics
                By enabling these features, you will be able to participate in the process of training a
                large language model by contributing data for future model improvements.

                When this phase 1 of VM model responds to you and you have opted-in, your conversation will be sent to 
                the developers working on this. Additionally, you can like/dislike its response. If you 
                dislike a response, you can suggest an alternative response. This data will be collected and 
                aggregated in the VM db.

                NOTE: By turning on this feature, you will be sending your data to the VM dev group accessible to IS. 
                ...
                will be openly available for the Devs to download and will be used by IS to improve
                We will retain all attribution information attached to your data.")
                focus: false
                readOnly: true
                Accessible.role: Accessible.Paragraph
        ...
        GridLayout {
            ...
            Label {
                id: optInStatistics
                text: qsTr("Opt-in to anonymous usage analytics used to improve ProjectLLM")
                Layout.row: 0
                Layout.column: 0
                color: theme.textColor
                font.pixelSize: theme.fontSizeLarge
            ...
            Label {
                id: optInNetwork
                text: qsTr("Opt-in to anonymous sharing of chats to Von Maur, Inc.")
                Layout.row: 1
                Layout.column: 0
                color: theme.textColor
                font.pixelSize: theme.fontSizeLarge
            ...
            RowLayout {
                ...
                RadioButton {
                    ...
                    Accessible.role: Accessible.RadioButton
                    Accessible.name: qsTr("Opt-in for network")
                    Accessible.description: qsTr("Allow opt-in anonymous sharing of chats to Von Maur, Inc.")
                ...
                RadioButton {
                    ...
                    Accessible.description: qsTr("Allow opt-out anonymous sharing of chats to Von Maur, Inc.")
