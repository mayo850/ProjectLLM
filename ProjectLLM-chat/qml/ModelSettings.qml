    ...
    contentItem: GridLayout {
            ...
            MyTextArea {
                ...
                onTextChanged: {
                    ...
                    if (!info.id) {
                        ...
                        errMsg = qsTr("Syntax error: %1").arg(jinjaError);
                        errState = "error";
                    } else if (legacyCheck()) {
        ...
        GridLayout {
            ...
            MyTextField {
                ...
                font.pixelSize: theme.fontSizeLarge
                color: theme.textColor
                ToolTip.text: qsTr("How many model layers to load into VRAM. Decrease this if VM AI runs out of VRAM while loading this model.\nLower values increase CPU load and RAM usage, and make inference slower.\nNOTE: Does not take effect until you reload the model.")
                ToolTip.visible: hovered
                Layout.row: 4
                Layout.column: 1
                Connections {
