...
ColumnLayout {
    ...
    Label {
        ...
        text: qsTr("These models have been specifically configured for use in this POC for VM possibly DG. The first few models on the " +
                   "list are known to work the best, but we should only attempt to use models that will fit in your " +
                   "available memory. (TODO: talk to Jeff/Dave about this)")
    ...
    Label {
        ...
        text: qsTr("Network error: could not retrieve %1").arg("http://ProjectLLM.io/models/models3.json")
            ...
            delegate: Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        // TODO Need to overhaul design here which must take into account
