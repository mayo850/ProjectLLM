...
/* Version 0: ProjectLLM v2.4.3, full-text search
 * Version 1: ProjectLLM v2.5.3, embeddings in hsnwlib
 * Version 2: ProjectLLM v3.0.0, embeddings in sqlite
 * Version 3: ProjectLLM v3.4.0, hybrid search
 */
