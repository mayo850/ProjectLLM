...
// This is a list of prompt templates known to ProjectLLM and their associated replacements which are automatically used
...
const std::unordered_map<std::string_view, std::string_view> CHAT_TEMPLATE_SUBSTITUTIONS {
    // calme-2.1-phi3.5-4b.Q6_K.gguf (reported by ThilotE on Discord), Phi-3.5-mini-instruct-Q4_0.gguf (nomic-ai/ProjectLLM#3345)
    {
        // original
...
{%- endif %})TEMPLATE",
    ...
    // gemma-2-9b-it-Q4_0.gguf (nomic-ai/ProjectLLM#3282)
    {
        // original
...
{%- endfor %})TEMPLATE",
    ...
    // granite-3.1-3b-a800m-instruct-Q4_0.gguf, granite-3.1-8b-instruct-Q4_0.gguf (nomic-ai/ProjectLLM#3471)
    {
        // original
...
{%- endif %})TEMPLATE",
    ...
    // Llama-3.2-1B-Instruct-Q4_0.gguf, Llama-3.2-3B-Instruct-Q4_0.gguf, SummLlama3.2-3B-Q4_0.gguf (nomic-ai/ProjectLLM#3309)
    {
        // original
        R"TEMPLATE({{- bos_token }}
...
{%- endif %})TEMPLATE",
    ...
    // Llama-3.3-70B-Instruct-Q4_0.gguf (nomic-ai/ProjectLLM#3305)
    {
        // original
        R"TEMPLATE({{- bos_token }}
{%- if custom_tools is defined %}
...
{%- endif %})TEMPLATE",
    ...
    // Llama3-DiscoLeo-Instruct-8B-32k-v0.1-Q4_0.gguf (nomic-ai/ProjectLLM#3347)
    {
        // original
...
{%- endif %})TEMPLATE",
    ...
    // Mistral-Nemo-Instruct-2407-Q4_0.gguf (nomic-ai/ProjectLLM#3284)
    {
        // original
        R"TEMPLATE({%- if messages[0]["role"] == "system" %}
    {%- set system_message = messages[0]["content"] %}
...
{%- endif %})TEMPLATE",
    ...
    // occiglot-7b-de-en-instruct.Q4_0.gguf (nomic-ai/ProjectLLM#3283)
    {
        // original
...
{%- endif %})TEMPLATE",
    ...
    // OLMoE-1B-7B-0125-Instruct-Q4_0.gguf (nomic-ai/ProjectLLM#3471)
    {
        // original
...
{%- endfor %})TEMPLATE",
    ...
    // OLMoE-1B-7B-0924-Instruct-Q4_0.gguf (nomic-ai/ProjectLLM#3471)
    {
        // original
...
{%- endfor %})TEMPLATE",
    ...
    // Phi-3.1-mini-128k-instruct-Q4_0.gguf (nomic-ai/ProjectLLM#3346)
    {
        // original
...
{%- endif %})TEMPLATE",
    ...
    // qwen2-1_5b-instruct-q4_0.gguf (nomic-ai/ProjectLLM#3263), qwen2-72b-instruct-q4_0.gguf
    {
        // original
