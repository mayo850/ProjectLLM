...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationDomain("ProjectLLM.io");
    QCoreApplication::setApplicationName("ProjectLLM");
...
#ifdef Q_OS_LINUX
    app.setWindowIcon(QIcon(":/ProjectLLM/icons/ProjectLLM_transparent.svg"));
#endif
    ...
    const QUrl url(u"qrc:/ProjectLLM/main.qml"_s);
