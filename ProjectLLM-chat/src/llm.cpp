...
#include <ProjectLLM-backend/sysinfo.h>
...
#ifdef ProjectLLM_OFFLINE_INSTALLER
...
#   pragma message(__FILE__ ": WARNING: offline installer build will not check for updates!")
    return QDesktopServices::openUrl(QUrl("https://github.com/nomic-ai/ProjectLLM/releases"));
#else
