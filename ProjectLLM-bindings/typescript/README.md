...
```js
import { createCompletion, loadModel } from "../src/ProjectLLM.js";
...
### Streaming responses
```js
import { loadModel, createCompletionStream } from "../src/ProjectLLM.js";
...
### Async Generators
```js
import { loadModel, createCompletionGenerator } from "../src/ProjectLLM.js";
...
```sh
curl -L https://ProjectLLM.io/models/models3.json -o ./models3.json
```
```js
import { createCompletion, loadModel } from 'ProjectLLM'
...
*   MingW script works to build the ProjectLLM-backend. We left it there just in case. **HOWEVER**, this package works only with MSVC built dlls.
...
- If you were a user of [these bindings](https://github.com/nomic-ai/ProjectLLM-ts), they are outdated.
