...
package_name = "ProjectLLM"

# Define the location of your prebuilt C library files
SRC_CLIB_DIRECTORY = os.path.join("..", "..", "ProjectLLM-backend")
SRC_CLIB_BUILD_DIRECTORY = os.path.join("..", "..", "ProjectLLM-backend", "build") 
...
setup(
    name=package_name,
    version="2.8.3.dev0",
    description="Python bindings for ProjectLLM",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    author="Nomic and the Open Source Community",
    author_email="support@nomic.ai",
    url="https://www.nomic.ai/ProjectLLM",
    project_urls={
        "Documentation": "https://docs.ProjectLLM.io/ProjectLLM_python.html",
        "Source code": "https://github.com/nomic-ai/ProjectLLM/tree/main/ProjectLLM-bindings/python",
        "Changelog": "https://github.com/nomic-ai/ProjectLLM/blob/main/ProjectLLM-bindings/python/CHANGELOG.md",
    },
    classifiers = [
    ...
    extras_require={
        ...
        'all': [
            'ProjectLLM[cuda]; platform_system == "Windows" or platform_system == "Linux"',
        ],
        'dev': [
            'ProjectLLM[all]',
            'pytest',
