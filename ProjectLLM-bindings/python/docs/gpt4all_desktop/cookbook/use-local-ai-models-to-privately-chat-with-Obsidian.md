# Using ProjectLLM to Privately Chat with your Obsidian Vault
...
!!! note "Connect Obsidian to LocalDocs"
      ...
      1. **Open LocalDocs**:
         - Navigate to the LocalDocs feature within ProjectLLM.

         <table>
            <tr>
               <td>
                  <!-- Screenshot of LocalDocs interface -->
                  <img width="1348" alt="LocalDocs interface" src="https://github.com/nomic-ai/ProjectLLM/assets/132290469/d8fb2d79-2063-45d4-bcce-7299fb75b144">
               </td>
            </tr>
         </table>
         ...
         <table>
            <tr>
               <td>
                  ...
                  <img width="1348" alt="Screenshot of adding collection" src="https://raw.githubusercontent.com/nomic-ai/ProjectLLM/124ef867a9d9afd9e14d3858cd77bce858f79773/ProjectLLM-bindings/python/docs/assets/obsidian_adding_collection.png">
               </td>
            </tr>
         </table>
         ...
         <table>
            <tr>
               <td>
                  ...
                  <img width="1447" alt="Accessing LocalDocs in chats" src="https://raw.githubusercontent.com/nomic-ai/ProjectLLM/124ef867a9d9afd9e14d3858cd77bce858f79773/ProjectLLM-bindings/python/docs/assets/obsidian_docs.png">
               </td>
            </tr>
         </table>
         ...
         <table>
            <tr>
               <td>
                  ...
                  <img width="662" alt="osbsidian user interaction" src="https://raw.githubusercontent.com/nomic-ai/ProjectLLM/124ef867a9d9afd9e14d3858cd77bce858f79773/ProjectLLM-bindings/python/docs/assets/osbsidian_user_interaction.png">
               </td>
            </tr>
         </table>
         <table>
            <tr>
               <td>
                  ...
                  <img width="662" alt="osbsidian ProjectLLM response" src="https://raw.githubusercontent.com/nomic-ai/ProjectLLM/124ef867a9d9afd9e14d3858cd77bce858f79773/ProjectLLM-bindings/python/docs/assets/obsidian_response.png">
               </td>
            </tr>
         </table>
      ...
      6. **View Referenced Files**:
         ...
         <table>
            <tr>
               <td>
                  <!-- Referenced Files  -->
                  <img width="643" alt="Referenced Files" src="https://raw.githubusercontent.com/nomic-ai/ProjectLLM/124ef867a9d9afd9e14d3858cd77bce858f79773/ProjectLLM-bindings/python/docs/assets/obsidian_sources.png">
               </td>
            </tr>
         </table>
