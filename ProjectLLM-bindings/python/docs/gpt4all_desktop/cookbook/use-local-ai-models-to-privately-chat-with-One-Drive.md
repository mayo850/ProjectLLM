# Using ProjectLLM to Privately Chat with your OneDrive Data

Local and Private AI Chat with your OneDrive Data

OneDrive for Desktop allows you to sync and access your OneDrive files directly on your computer. By connecting your synced directory to LocalDocs, you can start using ProjectLLM to privately chat with data stored in your OneDrive.
...
!!! note "Connect OneDrive to LocalDocs"
    ...
    1. **Install ProjectLLM and Open LocalDocs**:
    
        - Go to [nomic.ai/ProjectLLM](https://nomic.ai/ProjectLLM) to install ProjectLLM for your operating system.
        
        - Navigate to the LocalDocs feature within ProjectLLM to configure it to use your synced OneDrive directory.

        <table>
        <tr>
            <td>
                <!-- Placeholder for screenshot of LocalDocs interface -->
                <img width="1348" alt="Screenshot 2024-07-10 at 10 55 41 AM" src="https://github.com/nomic-ai/ProjectLLM/assets/132290469/54254bc0-d9a0-40c4-9fd1-5059abaad583">
            </td>
        </tr>
        </table>
    ...
    2. **Add Collection**:
        ...
        <tr>
            <td>
               ...
               <img width="1348" alt="Screenshot 2024-07-10 at 10 56 29 AM" src="https://github.com/nomic-ai/ProjectLLM/assets/132290469/7f12969a-753a-4757-bb9e-9b607cf315ca">
            </td>
        </tr>
        </table>
    ...
    4. **Access Files in Chats**:
        ...
        - Load a model within ProjectLLM to chat with your files.
        ...
        <tr>
            <td>
                ...
                <img width="1447" alt="Screenshot 2024-07-10 at 10 58 55 AM" src="https://github.com/nomic-ai/ProjectLLM/assets/132290469/b5a67fe6-0d6a-42ae-b3b8-cc0f91cbf5b1">
            </td>
        </tr>
        </table>
    ...
    5. **Interact With Your OneDrive**:
        ...
        <tr>
            <td>
                ...
                <img width="662" alt="Screenshot 2024-07-10 at 11 04 55 AM" src="https://github.com/nomic-ai/ProjectLLM/assets/132290469/2c9815b8-3d1c-4179-bf76-3ddbafb193bf">
            </td>
        </tr>
        </table>
        ...
        <tr>
            <td>
                <img width="662" alt="Screenshot 2024-07-11 at 11 21 46 AM" src="https://github.com/nomic-ai/ProjectLLM/assets/132290469/ce8be292-b025-415a-bd54-f11868e0cd0a">
            </td>
        </tr>
        </table>
    ...
    6. **View Referenced Files**:
        ...
        <tr>
            <td>
              <img width="643" alt="Screenshot 2024-07-11 at 11 22 49 AM" src="https://github.com/nomic-ai/ProjectLLM/assets/132290469/6fe3f10d-2791-4153-88a7-2198ab3ac945">
            </td>
        </tr>
        </table>
