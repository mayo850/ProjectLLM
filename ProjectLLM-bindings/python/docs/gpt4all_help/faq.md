...
All you need is to [install ProjectLLM](../index.md) onto you Windows, Mac, or Linux computer.
...
[Yes](https://github.com/nomic-ai/ProjectLLM/tree/main/ProjectLLM-bindings/cli), we have a lightweight use of the Python client as a CLI. We welcome further contributions!

## Hardware

### What hardware do I need?

ProjectLLM can run on CPU, Metal (Apple Silicon M1+), and GPU.
