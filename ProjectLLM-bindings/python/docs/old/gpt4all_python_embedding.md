# Embeddings
ProjectLLM supports generating high quality embeddings of arbitrary length text using any embedding model supported by llama.cpp.
...
=== "Embed4All Example"
    ```py
    from ProjectLLM import Embed4All
...
You can also use the GPU to accelerate the embedding model by specifying the `device` parameter. See the [ProjectLLM
...
[ProjectLLM constructor]: ProjectLLM_python.md#ProjectLLM.ProjectLLM.ProjectLLM.__init__
...
### API documentation
::: ProjectLLM.ProjectLLM.Embed4All
