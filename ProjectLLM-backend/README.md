# ProjectLLM Backend
This directory contains the C/C++ model backend used by ProjectLLM for inference on the CPU. This backend acts as a universal library/wrapper for all models that the ProjectLLM ecosystem supports. Language bindings are built on top of this universal library. The native ProjectLLM Chat application directly uses this library for all inference.

# What models are supported by the ProjectLLM ecosystem?
...
# How does ProjectLLM make these models available for CPU inference?
...
# Ok, so bottom line... how do I make my model on Hugging Face compatible with ProjectLLM ecosystem right now?
